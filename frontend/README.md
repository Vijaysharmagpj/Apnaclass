...
The ApnaClass ed-tech platform follows a client-server architecture with the following main components:
...
![System Architecture Diagram](https://github.com/yashsarode45/ApnaClass-Mega-Project/assets/65209607/3a154827-641d-4269-b662-203afcfd7654)

---

## Front-end

The front end of ApnaClass is built with ReactJS, offering a dynamic and responsive user interface for students and instructors. Here are some key pages and functionalities:
...
The back end of ApnaClass is built with NodeJS and ExpressJS and uses MongoDB as its primary database. Key features and functionalities include:
...
ApnaClass's API follows the REST architectural style, implemented using Node.js and Express.js. It uses JSON for data exchange and standard HTTP request methods. Sample API endpoints include:
...
ApnaClass is deployed on various cloud-based services:
